...
Related plan: Stitch Screen Production Plan
...
Use Russian UI copy as the primary visible language. English labels may appear only in internal layer names or optional notes, not as main UI copy.
...
Primary language on UI: Russian.
